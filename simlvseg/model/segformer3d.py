...
#
#     flops, params = profile(segformer3D, inputs=(input,))
...
if __name__ == "__main__":
    ...
    # step1 加载模型权重
    checkpoint_path = r'/workdir3t/A-Echo/hcc-echo-mae/lightning_logs/version_3/checkpoints/epoch=59-step=55920.ckpt'
    ...
    input = video_tensor[:, :, :, :, 0:112].cuda(0)
